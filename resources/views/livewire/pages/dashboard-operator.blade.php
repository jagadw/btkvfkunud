    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <h1 class="page-heading text-dark fw-bold fs-3 flex-column justify-content-center my-0">Dashboard Operator</h1>
                    ...
                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #F1416C;">
                        ...
                        <div class="card-body d-flex align-items-end mb-3">
                            <div class="d-flex justify-content-center flex-column">
                                <span class="fs-3hx text-white fw-bold me-6">{{ $JumlahUser }}</span>
                            </div>
                        </div>
                        <div class="card-footer">
                            <span class="fs-1 text-white">Jumlah User</span>
                        </div>
                    </div>
                </div>
                                <div class="col-xl-6">
