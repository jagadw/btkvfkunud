<div class="d-flex flex-column flex-column-fluid">
    <x-slot:title>Pasien Management</x-slot:title>
    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <button class="btn btn-sm fw-bold btn-primary" wire:click="resetForm" data-bs-toggle="modal" data-bs-target="#pasienModal">Add Patient</button>
            </div>
        </div>
    </div>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card p-5">
                <div class="mb-5">
                    <input type="text" wire:model.debounce.500ms="search" class="form-control form-control-solid w-250px" placeholder="Search Name">
                </div>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="#"
                                                       ...
                                                       data-bs-toggle="modal" data-bs-target="#pasienModal">
                                                        Edit
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item text-danger" href="#"
                                                       wire:click.prevent="deletePasien({{ $p->id }})"
