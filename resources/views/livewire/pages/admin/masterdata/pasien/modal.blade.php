        ...
        <div class="modal-content">
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" wire:model.defer="usia" class="form-control @error('usia') is-invalid @enderror" onkeydown="return event.keyCode !== 38 && event.keyCode !== 40;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">{{ $pasien_id ? 'Update' : 'Save' }}</button>
                </div>
