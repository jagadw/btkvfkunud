<div class="">
    ...
    <div class="custom-select2" id="customSelect2Mahasiswa">
        <div class="custom-select2-selected form-control form-control-solid" tabindex="0">
            {{ $selectedMahasiswa ? ($mahasiswas->firstWhere('id', $selectedMahasiswa)->nama ?? 'Select Mahasiswa') : 'Select Mahasiswa' }}
        </div>
        <div class="custom-select2-dropdown" style="display: none;">
            <input type="text" class="form-control mb-2 custom-select2-search" placeholder="Search Mahasiswa...">
