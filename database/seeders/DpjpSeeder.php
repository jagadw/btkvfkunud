...
class DpjpSeeder extends Seeder
{
    ...
    public function run(): void
    {
            ...
            $user1 = User::create([
                ...
                'password' => Hash::make('Nyoman Semadi'),
            ]);
            ...
            $user3 = User::create([
                ...
                'password' => Hash::make('Wayan Sudarma'),
            ]);
            ...
            $user4 = User::create([
                ...
                'password' => Hash::make('Komang Adhi'),
            ]);
            ...
            $user5 = User::create([
                ...
                'password' => Hash::make('Putu Kokohana'),
            ]);
